...
Do the above to the all the requirements
...
main.py - python code to run everything, every function is commented as specified in the assignment
...
with_regions.png - plot showing the data points with the smoothing curve overlaid and also the variable regions drawn
